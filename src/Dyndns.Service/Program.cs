...
builder.Services.AddSingleton<IUserStore>(_ => new FileBsonUserStore(
	Environment.GetEnvironmentVariable("DYNV6_UPDATER__USERS_FILE_PATH"),
	Environment.GetEnvironmentVariable("DYNV6_UPDATER__PASSWORD_PEPPER")));
